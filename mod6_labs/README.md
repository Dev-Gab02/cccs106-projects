...
## Screenshots
![alt text](src/assets/part1.png)
![alt text](src/assets/part1.1.png)
![alt text](src/assets/part2.png)
![alt text](src/assets/part2.1.png)
![alt text](src/assets/part3.png)
...
git clone https://github.com/Dev-Gab02/cccs106-projects.git
