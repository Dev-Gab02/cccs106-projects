...
class WeatherApp:
    ...
    def get_weather_color_scheme(self, weather_main: str, icon_code: str):
        ...
        Only affects the weather container, not the page background.
        """
        ...
        if is_night:
            return {
                'container': ft.Colors.INDIGO_900,
                'emoji': '🌙',
    ...
    def toggle_theme(self, e):
        """Toggle between light and dark theme with proper color updates"""
        if self.page.theme_mode == ft.ThemeMode.LIGHT:
            ...
            self.theme_button.icon_color = ft.Colors.WHITE
            
            # Update input field for dark mode
            self.city_input.bgcolor = ft.Colors.GREY_900
            self.city_input.color = ft.Colors.WHITE
            self.city_input.border_color = ft.Colors.BLUE_400
            
            # Update dropdown for dark mode
            self.history_dropdown.bgcolor = ft.Colors.GREY_900
            self.history_dropdown.color = ft.Colors.WHITE
            self.history_dropdown.border_color = ft.Colors.BLUE_400
            
            # Update error message color for dark mode
            self.error_message.color = ft.Colors.RED_300
            ...
            # Update input field for light mode
            self.city_input.bgcolor = ft.Colors.WHITE
            self.city_input.color = ft.Colors.BLACK
            self.city_input.border_color = ft.Colors.BLUE_700
            
            # Update dropdown for light mode
            self.history_dropdown.bgcolor = ft.Colors.WHITE
            self.history_dropdown.color = ft.Colors.BLACK
            self.history_dropdown.border_color = ft.Colors.BLUE_700
            
            # Update error message color for light mode
            self.error_message.color = ft.Colors.RED_700
    ...
    async def display_weather(self, data: dict):
        ...
        content = ft.Column(
            [
                ...
                # Weather emoji badge (BELOW LOCATION)
                ft.Container(
        ...
        # Update ONLY the container background color, not the page
